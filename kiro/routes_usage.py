...
from kiro.model_discovery import build_kiro_api_context, fetch_live_models
...
async def get_available_models(request: Request) -> Dict[str, Any]:
    ...
    # Try the live API first (works even for runtime.kiro.dev accounts — see model_discovery.py)
    ...
    logger.debug("[Models] Live fetch unavailable; falling back to cache")
